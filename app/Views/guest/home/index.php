                                ...
                                <div class="col-lg-8 col-md-8">
                                    <div class="banner-content banner-content3 banner-content3-1 pt-0">
                                        ...
                                        <div class="banner-btn" data-animation="fadeInUp" data-delay=".7s">
                                            <a href="<?= base_url('katalog'); ?>" class="fill-btn">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="product-tab-nav mb-60">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">Best Seller <span class="total-product">[<?= count($barang); ?>]</span></button>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12">
                <div class="category-banner-single category-banner2 mb-30 pos-rel">
                    <div class="category-banner-img">
                        <img src="<?= base_url(); ?>/assets/img/category_banner/category-banner5.jpg" alt="banner-img">
                    </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12">
                <div class="category-banner-single category-banner2 mb-30 pos-rel">
                    <div class="category-banner-img">
                        <img src="<?= base_url(); ?>/assets/img/category_banner/category-banner6.jpg" alt="banner-img">
                    </div>
                    <div class="category-banner-inner">
                        <div class="category-banner-content">
                                ...
                                <div class="testimonial-single">
                                    <div class="testimonial-content">
                                        ...
                                        <div class="author-thumb">
                                            <img src="<?= base_url(); ?>/assets/img/testimonial/author-1.jpg" alt="author img">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section class="newsletter-area pt-0 pb-120">
    <div class="container">
        <div class="newsletter-wrapper" data-background="<?= base_url(); ?>/assets/img/bg/newsletter-bg.png">
